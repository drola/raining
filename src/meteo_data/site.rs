...
trait SiteDownloader {
    fn get_radar_meta() -> Result<String, Box<dyn Error>>;
    fn get_radar_image(rel_path: &str) -> Result<Vec<u8>, Box<dyn Error>>;
}

struct MeteoArsoGovSiDownloader;
struct DummySiteDownloader;

impl MeteoArsoGovSiDownloader {
    fn new() -> MeteoArsoGovSiDownloader {
        MeteoArsoGovSiDownloader {}
    }
}

impl DummySiteDownloader {
    fn new() -> DummySiteDownloader {
        DummySiteDownloader {}
    }
}
